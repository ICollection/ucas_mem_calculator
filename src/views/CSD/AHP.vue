<template>
    <el-space wrap>
        <el-dropdown split-button type="primary" @command="loadData">
            ...
            <template #dropdown>
                <el-dropdown-menu>
                    <el-dropdown-item command="01">投资目标</el-dropdown-item>
                </el-dropdown-menu>
            </template>
        </el-dropdown>
...
function loadData(command: string) {
    switch (command) {
        case '01':
            comparison.renewalByJson('{"width":3,"height":3,"codes":["S1","S2","S3"],"names":["S1","S2","S3"],"rows":[{"Code":"S1","Name":"S1","S1":"1","S2":"1/3","S3":"2"},{"Code":"S2","Name":"S2","S1":"3","S2":"1","S3":"5"},{"Code":"S3","Name":"S3","S1":"1/2","S2":"1/5","S3":"1"}]}');
            break;
    }
}
/**
